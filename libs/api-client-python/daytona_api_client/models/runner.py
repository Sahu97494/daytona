...
class Runner(BaseModel):
    ...
    proxy_url: StrictStr = Field(description="The proxy domain of the runner", alias="proxyUrl")
    ...
    __properties: ClassVar[List[str]] = ["id", "domain", "apiUrl", "proxyUrl", "apiKey", "cpu", "memory", "disk", "gpu", "gpuType", "class", "used", "capacity", "region", "state", "lastChecked", "unschedulable", "createdAt", "updatedAt", "version"]
